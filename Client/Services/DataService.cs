...
namespace Client.Services
{
		...
		) : IDataService
	{
		...
		{
			var result = await _httpClient.GetAsync("api/user/quizes?CreationStatus=Success");
		...
		{
			var result = await _httpClient.GetAsync("api/user/algorithms?CreationStatus=Success");
