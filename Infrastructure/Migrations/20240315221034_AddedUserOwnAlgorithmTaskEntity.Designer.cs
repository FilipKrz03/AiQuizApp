...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240315221034_AddedUserOwnAlgorithmTaskEntity")]
    partial class AddedUserOwnAlgorithmTaskEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AlgorithmAnswer", b =>
                {
                    ...
                    b.Property<Guid>("AlgorithmTaskId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AlgorithmTaskId");

                    b.ToTable("AlgorithmAnswers");
                });
            ...
            modelBuilder.Entity("Domain.Entities.AlgorithmTask", b =>
                {
                    ...
                    b.Property<string>("TaskMainTopics")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AlgorithmTasks", (string)null);
            ...
            modelBuilder.Entity("Domain.Entities.UserOwnAlgorithmTask", b =>
                {
                    b.HasBaseType("Domain.Entities.AlgorithmTask");
                    ...
                    b.ToTable("UserOwnAlgorithmTasks", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.AlgorithmAnswer", b =>
                {
                    b.HasOne("Domain.Entities.AlgorithmTask", "AlgorithmTask")
                        .WithMany("Answers")
                        .HasForeignKey("AlgorithmTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AlgorithmTask");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOwnAlgorithmTask", b =>
                {
                    b.HasOne("Domain.Entities.AlgorithmTask", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.UserOwnAlgorithmTask", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", "User")
                        .WithMany("UserAlgorithms")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
